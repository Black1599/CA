...
(function(){
  ...
  function installFooterSettingsLinks(){
    ...
    var legalHref = isBlog ? '../aviso-legal.html' : 'aviso-legal.html';
    var privacyHref = isBlog ? '../privacidad.html' : 'privacidad.html';

    Array.prototype.forEach.call(document.querySelectorAll('.footer-legal span'), function(element){
      if ((element.textContent || '').trim() !== 'Aviso legal · Privacidad · Cookies') return;
      element.classList.add('footer-legal-links');
      element.innerHTML = '<a class="footer-legal-link" href="' + legalHref + '">Aviso legal</a> <span aria-hidden="true">·</span> <a class="footer-legal-link" href="' + privacyHref + '">Privacidad</a> <span aria-hidden="true">·</span> <button class="ca-cookie-settings-link" type="button" data-cookie-settings>Cookies</button>';
    });
