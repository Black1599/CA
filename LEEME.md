...
## intel16.12 - horario visual

La portada utiliza una tarjeta gráfica horizontal para el horario. La referencia
de código continúa siendo `HTML-HOME-SCHEDULE-01`.

La imagen está en `assets/images/horario-oficina-diseno-horizontal.webp`
(con PNG de respaldo). El horario textual se conserva en `index.html.md` y en
el `aria-label` del bloque para accesibilidad.
